...
while playAgain == 'y'
    ...
    while ~game_over
        ...
        if baby_crying
            ...
            ylabel("Click on items, find out what they do!")
        end
        
        xlabel(sprintf('Hunger: %.0f | Mood: %.0f | Entertainment: %.0f | Bottles: %i | Money Remaining: %.2f', ... 
            baby_hunger, baby_mood, baby_entertainment, FormulaCount,parent_budget));
